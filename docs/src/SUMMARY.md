...
- [Syntax Cheatsheet](./language/cheatsheet.md)
- [Values & Literals](./language/values.md)
- [Functions](./language/functions.md)
- [Operators](./language/operators.md)
- [Records & ADTs](./language/records.md)
- [Pattern Matching](./language/pattern-matching.md)
- [Lists](./language/lists.md)
- [Scopes & Bindings](./language/scopes.md)
...
- [Type Annotations (::)](./language/types.md)
- [Traits & Effects (:~)](./language/traits.md)
- [Documentation (:?)](./language/docs.md)
- [Parse Declarations (:!)](./language/parse-decls.md)
...
- [User-Defined Operators](./language/user-operators.md)
- [Security & Capabilities](./language/security.md)
